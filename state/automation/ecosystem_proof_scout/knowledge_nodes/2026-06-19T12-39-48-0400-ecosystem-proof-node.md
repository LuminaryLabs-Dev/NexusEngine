...
- id: ecosystem-proof-014-c
  ...
  evidence: Disposable Experiments `origin/0.0.2` worktree at `799fad882461502faa84b132f70de011e7dbe0cb` passed `npm run check`; targeted `node tests/dsk-first-wave-experiment-smoke.mjs` failed because `src/proof.js` resolved `../../../../NexusEngine/src/index.js` to missing `${TMPDIR}/NexusEngine/src/index.js`.
...
- branch: fetched-ref-module-resolution
  files or folders: `repo://NexusEngine-ProtoKits/package.json`, `protokits/nexus-dsk-adapter/index.js`, disposable worktree validation setup
