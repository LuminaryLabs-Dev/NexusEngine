...
- id: ecosystem-proof-022-g
  parent: ecosystem-proof-022
  lesson: Compatibility/content-safety is important hardening inventory but not distribution proof.
  evidence: Deep bug node `2026-06-19T19-54-18-0400`, domain idea node `2026-06-19T20-00-12-0400`, ecosystem state node `2026-06-19T20-10-14-0400`, and DSK architecture node `2026-06-19T20-24-13-0400` add legacy sequence replay/reset, legacy any loser cleanup, owning-kit lookup, and AR default text-safety rows while live proof evidence still shows package/sibling/browser module-resolution failures.
  look further: Route compatibility/content-safety rows into executable fixtures separately from public module-source and fetched-ref validation work.
- id: ecosystem-proof-022-h
  parent: ecosystem-proof-022
...
- reason: Preserves local-green/public-failing proof split while refreshing current fetched-ref drift, Playwright evidence, and compatibility/content-safety context.
- source: state/automation/ecosystem_state_scout/knowledge_nodes/2026-06-19T20-10-14-0400-ecosystem-state-node.md
- relationship: confirms
- reason: Confirms module-resolution blockers for ProtoKits fetched-ref proof, Experiments fetched-ref targeted proof, and public browser proof while keeping compatibility/content-safety separate.
- source: state/automation/dsk_architecture_scout/knowledge_nodes/2026-06-19T20-24-13-0400-dsk-architecture-node.md
- relationship: constrains
- reason: Separates runtime failure-boundary, lifecycle parity, query/command semantics, experience-edge, read-model/orchestration, compatibility/content-safety, proof-readiness taxonomy, and public module-source proof.
- source: state/automation/deep_bug_report_scout/knowledge_nodes/2026-06-19T19-54-18-0400-deep-bug-node.md
- relationship: references
- reason: Keeps legacy sequence replay/reset, any cleanup, owning-kit lookup, and AR text-safety rows as hardening fixture inputs, not distribution proof.
- source: state/automation/domain_kit_idea_expander/knowledge_nodes/2026-06-19T20-00-12-0400-domain-kit-idea-node.md
- relationship: expands
- reason: Converts compatibility/content-safety findings into proof-row planning without replacing module-source work.
...
- branch: compatibility-content-safety-proof
  ...
  question: Which legacy replay/reset, any cleanup, owning-kit lookup, and AR text-safety rows belong after base hardening work starts?
