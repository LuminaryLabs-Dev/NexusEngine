...
- Local and disposable targeted first-wave DSK proof still fails before assertions because `tests/dsk-first-wave.test.mjs` imports bare package `nexusengine`.
