...
- `https://luminarylabs-agents.github.io/NexusEngine-Experiments/experiments/dsk-first-wave-proof/` -> 200 by curl/fetch and Playwright navigation, but visible proof remains `Booting...`
