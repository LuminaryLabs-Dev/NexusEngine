# Knowledge Nodes: ecosystem_state_scout 2026-06-19T19-10-05-0400

## Root Lesson
- id: ecosystem-root-021
- statement: Core remains current and validation-green, but ecosystem proof readiness is unchanged: the shared module-source strategy still blocks ProtoKits fetched-ref proof, Experiments fetched-ref targeted proof, and public browser proof; read-model/orchestration isolation is separate runtime hardening inventory, not distribution proof.
- why it matters: Promotion review still needs one explicit module-source model before fetched-ref and public proof can converge, and it must keep registry/surface/SequenceNode hardening, proof taxonomy, aggregate/targeted parity, npm availability, package-version policy, and browser-complete proof as separate claims.

## Child Nodes
- id: core-still-current-2026-06-19-1910
...
- id: protokits-package-resolution-2026-06-19-1910
  parent: ecosystem-root-021
  lesson: ProtoKits local available-checkout proof is green, but fetched latest-ref proof still fails without a resolvable `nexusengine` package.
  evidence: Local ProtoKits `npm run check` and `node tests/dsk-first-wave.test.mjs` passed at `40d70b93bef6a0e88dadc48067aa4fd2844284f8`; disposable extracted `origin/0.0.2` at `06f5f3bd35e3b4c2c24d49d4affbe026b0d92c8f` failed `smoke:imports` with 110 import failures rooted in `ERR_MODULE_NOT_FOUND` for package `nexusengine`; targeted DSK smoke failed for the same package.
  look further: Validate fetched ProtoKits with a declared package, workspace, CDN, or link model for NexusEngine.
- id: experiments-targeted-fetched-ref-resolution-2026-06-19-1910
  parent: ecosystem-root-021
  ...
  evidence: Disposable extracted Experiments `origin/0.0.2` at `799fad882461502faa84b132f70de011e7dbe0cb` passed `npm run check`; targeted `node tests/dsk-first-wave-experiment-smoke.mjs` failed because `src/proof.js` resolved `../../../../NexusEngine/src/index.js` to missing `${TMPDIR}/NexusEngine/src/index.js`.
  look further: Run targeted DSK proof with the same module-source strategy intended for public proof.
- id: public-proof-import-shape-2026-06-19-1910
  parent: ecosystem-root-021
  lesson: The public DSK proof route remains HTTP-visible but browser-stuck at `Booting...`.
  evidence: Direct fetch returned 200 for the proof route; Playwright snapshot showed heading text plus `Booting...`; console/request checks showed 404s for `NexusEngine/src/index.js`, ProtoKits `domain-foundation`, and ProtoKits `domain-service-kits`.
  look further: Choose CDN `0.0.2`, same-origin deployed assets, or a build-step import map for the public proof route.
- id: module-source-strategy-2026-06-19-1910
  parent: ecosystem-root-021
  ...
  evidence: ProtoKits failed on package-name `nexusengine`; Experiments targeted proof failed on missing sibling `NexusEngine`; public route failed on deployed sibling module 404s.
  look further: Define one resolution model and use it in local, disposable, and public proof paths.
- id: aggregate-dsk-proof-validation-2026-06-19-1910
  parent: ecosystem-root-021
...
- id: generated-route-validation-boundary-2026-06-19-1910
  parent: ecosystem-root-021
...
- id: read-model-orchestration-isolation-2026-06-19-1910
  parent: ecosystem-root-021
  lesson: Registry descriptor isolation, surface snapshot isolation, SequenceNode race cleanup, and SequenceNode `any` receipt policy are new hardening inventory, not proof that module-source routing is fixed.
  evidence: Deep bug node `2026-06-19T18-55-33-0400` and domain idea node `2026-06-19T19-00-18-0400` add registry/surface/SequenceNode rows; live proof evidence still shows package/sibling/browser module-resolution failures.
  look further: Decide whether these rows become a fifth hardening tranche or split under runtime failure-boundary and lifecycle parity fixtures.
- id: public-consumption-npm-gap-2026-06-19-1910
  parent: ecosystem-root-021
...
- id: package-version-policy-2026-06-19-1910
  parent: ecosystem-root-021
...
- reason: Preserves module-source blockers while refreshing live preflight, local checks, fetched-ref checks, public URL checks, and Playwright evidence plus newer read-model/orchestration isolation context.
...
- reason: Keeps proof-readiness queueing and runtime hardening categories separate from public module-source proof.
- source: `state/automation/deep_bug_report_scout/knowledge_nodes/2026-06-19T18-55-33-0400-deep-bug-node.md`
- relationship: expands
- reason: Adds registry descriptor, surface snapshot, and SequenceNode lifecycle/receipt isolation as hardening inputs.
- source: `state/automation/domain_kit_idea_expander/knowledge_nodes/2026-06-19T19-00-18-0400-domain-kit-idea-node.md`
- relationship: expands
- reason: Converts read-model/orchestration bug evidence into planning boundaries without replacing module-source work.
...
- branch: protokits-package-resolution
  files or folders: `repo://NexusEngine-ProtoKits/package.json`, `protokits/nexus-dsk-adapter/index.js`, fetched `origin/0.0.2`
...
- branch: read-model-orchestration-isolation
  ...
  question: Which registry/surface/SequenceNode isolation rows belong in executable fixtures after base module-source and runtime failure-boundary decisions?
...
- This node does not claim read-model/orchestration isolation rows are fixed.
