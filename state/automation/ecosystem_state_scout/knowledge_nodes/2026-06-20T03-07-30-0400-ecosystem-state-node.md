...
- id: experiments-targeted-fetched-ref-resolution-2026-06-20-0307
  ...
  evidence: Local Experiments `HEAD` was `799fad882461502faa84b132f70de011e7dbe0cb`; fetched `origin/0.0.2` was `81b39bccadf2cdf8269df24cd4970a5b2d7ebbd9`; ahead/behind was `0 10`; disposable fetched-ref `npm run check` generated 100 flat route wrappers and passed; targeted `node tests/dsk-first-wave-experiment-smoke.mjs` failed because `src/proof.js` resolved `../../../../NexusEngine/src/index.js` to missing `${TMPDIR}/NexusEngine/src/index.js`.
