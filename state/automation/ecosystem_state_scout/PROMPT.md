...
PROCESS:
1. Start by restating this lane goal in the packet draft: audit NexusRealtime ecosystem state, drift, and proof readiness.
...
6. If sibling repos are present, inspect NexusRealtime-ProtoKits and NexusRealtime-Experiments branch/status plus their DSK ledgers/proof routes.
