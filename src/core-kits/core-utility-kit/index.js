...
import { createAngleUtilityKit } from './angle-utility-kit.js';
...
import { createVectorUtilityKit } from './vector-utility-kit.js';

export * from './angle-utility-kit.js';
...
export function createCoreUtilityKit(config = {}) {
  ...
  return createCoreCapabilityKit({
    ...
    purpose: 'Nexus Utility Domain: shared utility kits for transform math, angles, vectors, camera control, rig transforms, IK, quaternions, and debug draw descriptors.',
    owns: ['utility registry', 'transform math helpers', 'angle helpers', 'vector helpers', 'camera control helpers', 'rig transform helpers', 'IK helpers', 'quaternion helpers', 'debug draw descriptors'],
