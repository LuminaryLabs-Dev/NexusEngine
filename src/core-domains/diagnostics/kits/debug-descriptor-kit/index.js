...
export function createDebugDescriptorKit(config = {}) {
  return createDomainKit({
    ...config,

    manifestId: "debug-descriptor-kit",
    id: config.id ?? "debug-descriptor-kit",

    domainPath: config.domainPath ?? "n:diagnostics",
    domain: "debug-descriptors",

    apiName: config.apiName ?? "debugDescriptors",
