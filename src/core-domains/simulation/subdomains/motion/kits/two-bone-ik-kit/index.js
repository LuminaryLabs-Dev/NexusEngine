import {
  ...
  sub,
  vec3
} from "nexusengine/domains/spatial/transform-math";
...
export function createTwoBoneIKKit(config = {}) {
  return createDomainKit({
    ...config,
    manifestId: "two-bone-ik-kit",
    id: "two-bone-ik-kit",
    domain: "two-bone-ik",
    domainPath: "n:simulation:motion",
    parentDomainPath: "n:simulation",
    apiName: "twoBoneIk",
    provides: ["motion:inverse-kinematics"],
    purpose: "Solve deterministic two-bone inverse-kinematics poses without renderer or physics ownership.",
    createApi: () => ({ clampTargetToReach, projectPoleDirection, solveTwoBoneIK })
  });
}
