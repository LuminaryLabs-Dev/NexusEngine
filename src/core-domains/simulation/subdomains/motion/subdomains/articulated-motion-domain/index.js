...
import {
  solveTwoBoneIK
} from "nexusengine/domains/simulation/motion/two-bone-ik";
import {
...
export function createArticulatedMotionDomain(config = {}) {
  return defineDomainServiceKit({
    manifestId: "articulated-motion-kit",
    id: config.id ?? "articulated-motion-kit",
    domain: "articulated-motion",
    domainPath: "n:simulation:motion:articulated",
    ...
    requires: config.requires ?? ["n:simulation:motion"],
    provides: [
