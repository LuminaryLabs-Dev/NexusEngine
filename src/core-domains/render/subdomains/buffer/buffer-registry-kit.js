...
export function createBufferRegistryKit(config) {
  const {
    manifestId,
    id,
    domain,
    ...
    createApi({ baseApi, engine }) {
      ...
      function validate(record) {
        return validateRecord(record, {
          engine,
          buffers: () => requiredApi(engine, "renderBuffers", purpose),
          layouts: () => requiredApi(engine, "renderBufferLayouts", purpose)
        });
      }
...
export default createBufferRegistryKit;
