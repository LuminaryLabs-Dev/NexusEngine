...
export function createPresentationOutputKit(config = {}) {
  return defineDomainServiceKit({
    manifestId: "presentation-output-kit",
    id: config.id ?? "presentation-output-kit",
    domain: "presentation-output",
    domainPath: config.domainPath ?? "n:presentation:output",
