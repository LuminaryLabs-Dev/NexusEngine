...
export const REFLECTION_CAPABILITIES = Object.freeze([
  "n:presentation:graphics:reflection",
  "n:presentation:graphics:reflection-descriptor",
  "n:presentation:graphics:reflection-policy",
  "n:presentation:graphics:reflection-negotiation",
  "n:presentation:graphics:reflection-frame-receipt"
]);
