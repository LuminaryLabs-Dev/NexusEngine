...
export function createCaptureKit(config = {}) {
  return defineDomainServiceKit({
    manifestId: "capture-contract-kit",
    id: config.id ?? "capture-contract-kit",
    domain: "capture",
    domainPath: config.domainPath ?? "n:presentation:capture",
    parentDomainPath: config.parentDomainPath ?? "n:presentation",
    apiName: config.apiName ?? "capture",
...
export default createCaptureKit;
