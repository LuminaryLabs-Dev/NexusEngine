...
import { DEFAULT_CAMERA_FRAMING_POLICY } from "../../../../contracts.js";
import {
  add3,
...
export function createCameraFramingKit(config = {}) {
  return defineDomainServiceKit({
    manifestId: "camera-framing-kit",
    id: config.id ?? "camera-framing-kit",
