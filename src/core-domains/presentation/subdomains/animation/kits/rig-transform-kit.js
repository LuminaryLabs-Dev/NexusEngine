import { directionBetween, midpoint, segmentLength } from "nexusengine/domains/spatial/transform-math";
...
export function createRigTransformKit(config = {}) {
  return createDomainKit({
    ...config,
    manifestId: "rig-transform-kit",
    id: "rig-transform-kit",
    domain: "rig-transform",
    domainPath: "n:presentation:animation",
    parentDomainPath: "n:presentation",
    apiName: "rigTransform",
    provides: ["animation:rig"],
    purpose: "Create renderer-neutral rig joints, limbs, and segment descriptors.",
    createApi: () => ({
