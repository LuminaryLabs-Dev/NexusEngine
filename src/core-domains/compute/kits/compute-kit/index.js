...
export function createComputeKit(config = {}) {
  return defineDomainServiceKit({
    manifestId: "compute-graph-kit",
    id: config.id ?? "compute-graph-kit",
    domain: "compute",
    domainPath: config.domainPath ?? "n:compute",
    apiName: config.apiName ?? "compute",
    version: CORE_COMPUTE_VERSION,
...
export default createComputeKit;
