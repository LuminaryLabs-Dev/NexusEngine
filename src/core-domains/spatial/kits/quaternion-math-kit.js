import { clamp } from "./transform-math-kit.js";
...
export function createQuaternionMathKit(config = {}) {
  return createDomainKit({
    ...config,
    manifestId: "spatial-quaternion-math-kit",
    id: "spatial-quaternion-math-kit",
    domain: "spatial-quaternion",
    domainPath: "n:spatial",
    apiName: "quaternionMath",
    provides: ["spatial:quaternion-math"],
    purpose: "Provide deterministic quaternion construction, rotation, interpolation, and comparison operations.",
    createApi: () => ({
      quatIdentity, quatNormalize, quatConjugate, quatInverse, quatMultiply,
      quatFromAxisAngle, quatFromUnitVectors, quatRotateVector, quatSlerp,
      quatFromBasis, quatDot, quatAngleBetween, quatAlmostEqual
    })
  });
}
