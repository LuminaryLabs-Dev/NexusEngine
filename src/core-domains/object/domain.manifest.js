...
export const objectDomainManifest = defineCoreDomainManifest({
  ...
  subdomains: [
    ...
    subdomain({
      ...
      proof: ["src/core-domains/object/subdomains/placement/tests/placement-smoke.mjs", "src/core-domains/object/subdomains/placement/tests/placement-roundtrip.mjs"]
    })
  ],
  ...
  publicKits: [
    ...
    atomicKit({ id: "object-shape-kit", responsibility: "Derive and qualify renderer-neutral geometric shape candidates.", domainPath: "n:object:shape", apiName: "objectShape", requires: ["object:descriptor-contract"], provides: ["n:object:shape", "object:shape-source", "object:shape-qualified", "object:shape-jobs"], module: "./src/core-domains/object/subdomains/shape/kits/object-shape-kit/index.js", exportName: "createObjectShapeKit", publicSubpath: "./domains/object/shape", proof: ["tests/core-domains/core-object-shape-domain-smoke.mjs", "tests/core-domains/core-object-shape-skinned-qualification-smoke.mjs"] }),
    atomicKit({ id: "object-fidelity-kit", responsibility: "Package and select valid object fidelity forms.", domainPath: "n:object:fidelity", apiName: "objectFidelity", requires: ["object:descriptor-contract"], provides: ["n:object:fidelity", "object:fidelity-forms", "object:fidelity-packages"], module: "./src/core-domains/object/subdomains/fidelity/kits/object-fidelity-kit/index.js", exportName: "createObjectFidelityKit", publicSubpath: "./domains/object/fidelity", proof: ["tests/core-domains/core-object-fidelity-domain-smoke.mjs"] }),
    atomicKit({ id: "object-vegetation-kit", responsibility: "Own deterministic plant species, instances, and lifecycle state.", domainPath: "n:object:vegetation", apiName: "vegetation", requires: ["n:object"], provides: ["n:object:vegetation", "vegetation:species", "vegetation:instances", "vegetation:lifecycle"], module: "./src/core-domains/object/subdomains/vegetation/kits/object-vegetation-kit/index.js", exportName: "createVegetationKit", publicSubpath: "./domains/object/vegetation", proof: ["tests/core-domains/core-object-vegetation-domain-smoke.mjs", "tests/core-domains/core-object-vegetation-natural-growth-smoke.mjs"] }),
    atomicKit({ id: "object-tree-kit", responsibility: "Produce deterministic tree structure, canopy, growth, and fidelity descriptors.", domainPath: "n:object:vegetation:tree", apiName: "vegetationTree", requires: ["n:object:vegetation"], provides: ["n:object:vegetation:tree", "vegetation:tree-structure", "vegetation:tree-growth"], module: "./src/core-domains/object/subdomains/vegetation/subdomains/tree-domain/index.js", exportName: "createTreeDomainKit", publicSubpath: "./domains/object/vegetation/tree", proof: ["tests/core-domains/core-object-vegetation-natural-growth-smoke.mjs"] }),
    atomicKit({ id: "object-foliage-kit", responsibility: "Produce deterministic foliage structures and descriptors.", domainPath: "n:object:vegetation:foliage", apiName: "vegetationFoliage", requires: ["n:object:vegetation"], provides: ["n:object:vegetation:foliage", "vegetation:foliage"], module: "./src/core-domains/object/subdomains/vegetation/subdomains/foliage-domain/index.js", exportName: "createFoliageDomainKit", publicSubpath: "./domains/object/vegetation/foliage", proof: ["tests/core-domains/core-object-vegetation-domain-smoke.mjs"] }),
    atomicKit({ id: "object-vegetation-ecology-kit", responsibility: "Score vegetation suitability and select species deterministically.", domainPath: "n:object:vegetation:ecology", apiName: "vegetationEcology", requires: ["n:object:vegetation"], provides: ["n:object:vegetation:ecology", "vegetation:ecology-score"], module: "./src/core-domains/object/subdomains/vegetation/subdomains/ecology-domain/index.js", exportName: "createVegetationEcologyKit", publicSubpath: "./domains/object/vegetation/ecology", proof: ["tests/core-domains/core-object-vegetation-domain-smoke.mjs"] }),
    atomicKit({ id: "object-placement-kit", responsibility: "Create, validate, and replay deterministic object placement receipts.", domainPath: "n:object:placement", apiName: "objectPlacement", requires: ["object:descriptor-contract"], provides: ["n:object:placement", "object:placement-descriptor", "object:placement-receipt"], module: "./src/core-domains/object/subdomains/placement/kits/object-placement-kit/index.js", exportName: "createObjectPlacementKit", publicSubpath: "./domains/object/placement", proof: ["src/core-domains/object/subdomains/placement/tests/placement-smoke.mjs", "src/core-domains/object/subdomains/placement/tests/placement-roundtrip.mjs"] }),
    atomicKit({ id: "object-meshoptimizer-shape-provider-kit", kind: "provider-kit", responsibility: "Resolve object shape jobs through an explicitly registered meshoptimizer-compatible provider.", domainPath: "n:object:shape", apiName: "meshoptimizerShapeProvider", requires: ["object:shape-jobs"], provides: ["object:shape-provider"], module: "./src/core-domains/object/subdomains/shape/providers/meshoptimizer-shape-provider-kit/index.js", exportName: "createMeshoptimizerShapeProviderKit", publicSubpath: "./domains/object/shape/meshoptimizer-provider", proof: ["tests/core-domains/core-object-shape-domain-smoke.mjs"] }),
  ...
  providers: [{
    ...
    source: { module: "./src/core-domains/object/subdomains/shape/providers/meshoptimizer-shape-provider-kit/index.js" },
