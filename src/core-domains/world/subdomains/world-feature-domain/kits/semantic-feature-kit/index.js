...
export function createSemanticWorldFeatureHandler(spec = {}) {
...
export function createSemanticWorldFeatureKit(config = {}) {
  return createDomainKit({
    ...config,
    manifestId: "semantic-world-feature-kit",
    id: "semantic-world-feature-kit",
    domain: "semantic-world-feature",
    ...
    purpose: "Create bounded semantic world feature handlers from deterministic specifications.",
    createApi: () => ({ create: createSemanticWorldFeatureHandler })
  });
}
