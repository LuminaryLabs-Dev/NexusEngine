...
export function createWorldFeatureDomain(config = {}) {
  ...
  return createDomainKit({
    ...config,
    manifestId: "world-feature-kit",
    id: config.id ?? "world-feature-kit",
    domain: "world-feature",
    domainPath: config.domainPath ?? "n:world:feature",
    parentDomainPath: config.parentDomainPath ?? "n:world",
    apiName: config.apiName ?? "worldFeature",
    ...
    createApi({ engine, baseApi }) {
      ...
      function compileCell(cell, context = {}) {
        ...
        const foundation = context.foundation ?? engine.n?.worldFoundation;
      ...
      const api = {
        ...
        releaseCompiledCell(cellId, options = {}) {
          ...
          const foundation = options.foundation ?? engine.n?.worldFoundation;
