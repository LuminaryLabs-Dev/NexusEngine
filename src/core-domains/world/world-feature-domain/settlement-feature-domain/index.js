...
import {
  createSemanticWorldFeatureHandler,
  finiteNumber,
...
function areaSettlementKit({ type, defaults, sampleKey = "density", materialKind = null, collisionKind = null, fidelity }) {
  return (config = {}) => createSemanticWorldFeatureHandler({
    type,
    family: "settlement",
...
export function createSettlementFeatureKit(config = {}) {
  return createSemanticWorldFeatureHandler({
    type: "settlement",
    family: "settlement",
...
export function createSettlementFeatureDomain(config = {}) {
  return createWorldFeatureFamilyDomain(config, {
    family: "settlement",
    manifestId: "settlement-feature-kit",
    id: "settlement-feature-kit",
    domain: "settlement-feature",
    domainPath: "n:world:feature:settlement",
    apiName: "settlementFeature",
