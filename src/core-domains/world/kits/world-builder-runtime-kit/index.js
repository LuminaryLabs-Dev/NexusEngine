...
export function createWorldBuilderRuntime(options = {}) {
  ...
  function updateWorld(id) {
    ...
    return createWorldRecordSnapshot(worldState);
  }
  ...
  function snapshot(id, snapshotOptions = {}) {
    ...
    return createWorldRecordSnapshot(worldState, providerData);
  }

  function snapshotAll(snapshotOptions = {}) {
    if (snapshotOptions.includeProviders === false) return createWorldSnapshot(readState());
    return createWorldSnapshot(readState(), runtimeWorlds);
  }
