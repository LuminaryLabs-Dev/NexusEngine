...
export function createAssetRegistryKit(config = {}) {
  return defineDomainServiceKit({
    manifestId: "asset-registry-kit",
    id: config.id ?? "asset-registry-kit",
    domain: "asset",
    domainPath: config.domainPath ?? "n:asset",
    apiName: config.apiName ?? "asset",
    version: CORE_ASSETS_VERSION,
...
export default createAssetRegistryKit;
