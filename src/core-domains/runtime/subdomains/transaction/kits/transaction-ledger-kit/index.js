...
export function createTransactionLedgerKit(config = {}) {
  return createDomainKit({
    ...config,
    manifestId: "transaction-ledger-kit",
    id: config.id ?? "transaction-ledger-kit",
    domain: "transaction",
    domainPath: config.domainPath ?? "n:runtime:transaction",
    parentDomainPath: config.parentDomainPath ?? "n:runtime",
    apiName: config.apiName ?? "transaction",
...
export default createTransactionLedgerKit;
