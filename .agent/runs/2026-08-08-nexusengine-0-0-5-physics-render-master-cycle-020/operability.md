...
- Active local package: master-package-n-physics-collider
...
- **ACTIVE_LOCAL_PACKAGE:** master-package-n-physics-collider has local unreconciled work and must receive a diff audit, not a clean-slate implementation proposal.
...
| 3 | `master-package-n-physics-collider` | `n:physics` | active-local-unreconciled | 84 | 3 | audit-current-diff-only |
...
| 4 | `master-package-n-physics-detection` | `n:physics` | dependency-blocked | 77 | 2 | generate-read-only-review-packet |
